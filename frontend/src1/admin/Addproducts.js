...
const Addproducts = ({ isLoggedIn1}) => {
    ...
    function upaddprod(pid,name,description,quantity,price,overview,brand
        ) {
                        ...
                        viewproduct.map((result, index) => {
                            return (
                                <tr key={index}>
                                    ...
                                    <td>{result.brand}</td>
                                    <td style={{ textTransform: 'capitalize' }}>{result.name}
                                    <br/>Price : ₹ {result.price}.00
                                    ...
                                    <td> <span onClick={() => { upaddprod(result.pid, result.name, result.description, result.quantity, result.price,result.overview,result.brand); }}>
                            ...
                            <div className="shadow" style={{margin:'0 auto',width:"90%",padding:'10px'}}>
                             ...
                             {medit ? <>
                                ...
                                <input type="number" placeholder="Price" required style={{ width:'100%' }}
                                  id="price"  onChange={e => setAddpprice(e.target.value)} />
                                <br /><br />
