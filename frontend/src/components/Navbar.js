    ...
    <div style={{ marginBottom: '68px' }}>
        ...
        <div className="container-fluid">
          ...
          <div className="collapse navbar-collapse" id="navbarNavDropdown">
            ...
            <ul className="navbar-nav ralign-content">
              <li className="nav-item">
                    <NavLink to="/Addsegments" target="_blank" className="nav-link" > Admin</NavLink>
              </li>
              {/* --------------show nav-------------- */}
              <li className="nav-item">
      ...
      <div className="offcanvas offcanvas-start  nvbr-offcanvas" data-bs-backdrop="static" tabIndex="-1" id="staticBackdrop" aria-labelledby="staticBackdropLabel">
        ...
        <div className="offcanvas-body">
          ...
          <div>
          <NavLink to="/Cart" style={{textDecoration:"none",color:'white'}}>My Cart</NavLink>
          </div>
          <div>
       <NavLink to="/Myorder" style={{textDecoration:"none",color:'white'}}>My Orders</NavLink>

          </div>
          <div>
            <span style={{ cursor: 'pointer',color:'white'}} onClick={logout}>Logout</span>
          </div>
          <hr/>
