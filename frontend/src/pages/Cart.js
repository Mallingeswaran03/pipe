...
const Cart = ({ isLoggedIn }) => {
  ...
  const addckout = async (event) => {
   ...
   const addckout1212 = async (token) => {
     ...
     try {
      ...
      var email = localStorage.getItem("userEmail");
      var name = localStorage.getItem("userName");
       const result = await axios.post("http://localhost:8081/fnckout1212", { token, st,uid,email,name });
       if (result.data === "success") {
       
         document.getElementById("btnccllkk").click();
       }
       else{
            ...
            <div className="modal-body">
              ...
              <form id='addckout' onSubmit={addckout}>
                <div className='row'>
                  ...
                  <div className='col-md-12 col-sm-12' style={{ padding: '20px' }}>
                  ...
                  <div className='col-sm-12' style={{ padding: '5px', textAlign: 'center' }}>
                    <button id="btnccllkk" style={{visibility:'hidden'}}>
              ...
              {address!=='' ?
                ...
                <StripeCheckout
                  name="Pay Now"
                  amount={st * 100}
                  stripeKey="pk_test_51P0dthSIH9yAlEwXMPQbIhk8dMeBbGp1wdJWrzsEPb0odnetwmVoPNuO5EhNTUo1K6Vd2GjVEO0Mlbzoj4DC2a9i00J5kgy3lA"
                  currency='INR'
                ...
                /> :
                <span className='btn btn-sm btn-success' onClick={() => { alert("Enter address"); }}>Pay Now</span>
