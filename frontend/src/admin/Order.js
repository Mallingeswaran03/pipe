...
const Order = ({ isLoggedIn1 }) => {
    ...
    const exportToExcel = () => {
            ...
            const exportToPDF = () => {
                ...
                // Add additional content at the top
                const additionalContent = `
                    Ambaal pipes,
                    Sathy Road Near SRI RAM lodge,Erode-3
                    ambalupvc@gmail.com
                `;
                doc.text(additionalContent, 10, 10); // Adjust coordinates as needed
                ...
                doc.autoTable({
                    ...
                    margin: { top: 40 }, // Adjust margin to accommodate additional content
                    theme: 'striped',
                });
